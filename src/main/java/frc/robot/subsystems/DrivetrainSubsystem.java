...
import static frc.robot.settings.Constants.Field.BLUE_BACK_CENTER_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.BLUE_BACK_LEFT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.BLUE_BACK_RIGHT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.BLUE_FRONT_CENTER_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.BLUE_FRONT_LEFT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.BLUE_FRONT_RIGHT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.RED_BACK_CENTER_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.RED_BACK_LEFT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.RED_BACK_RIGHT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.RED_FRONT_CENTER_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.RED_FRONT_LEFT_REEFSIDE_POSE;
import static frc.robot.settings.Constants.Field.RED_FRONT_RIGHT_REEFSIDE_POSE;
