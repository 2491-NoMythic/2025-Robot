...
public class LimelightInputs implements LoggableInputs{
    ...
    public double getClosestTagDistRobotSpace() {
        return MythicalMath.DistanceFromOrigin3d(targetInRobotSpace.getX(), targetInRobotSpace.getY(), targetInRobotSpace.getZ());
    }
...
//the following were auto-generated by the @AutoLog annotation
    ...
    public void fromLog(LogTable table) {
        megaTag2Pose2d = table.get("MegaTag2Pose2d", Pose2d.struct, (Pose2d) null); //uses a struct so that the get() method will function with a default null
